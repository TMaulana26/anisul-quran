...
CONTAINER_NAME="anisul_quran_app"
MAX_RETRIES=15
RETRY=0
IS_HEALTHY=false
...
if [ "$IS_HEALTHY" = "true" ]; then
    echo ""
    echo -e "${GREEN}================================================================${NC}"
    echo -e "${GREEN}  🎉 DEPLOYMENT BERHASIL! ANISUL QUR'AN AKTIF & SEHAT 🎉         ${NC}"
    echo -e "${GREEN}================================================================${NC}"
    echo ""
    ...
    echo -e "  • Akses CLI Artisan: ${YELLOW}sudo docker exec -it $CONTAINER_NAME php artisan${NC}"
    echo ""
else
    echo ""
    echo -e "${RED}================================================================${NC}"
